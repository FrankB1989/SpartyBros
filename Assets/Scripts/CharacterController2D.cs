...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		{
            doJump();
        }else if(_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) //if can double jump and jump button press then allow player to double jump
        {
            doJump();
            //disable double jump after double jumping since you can only really do once
